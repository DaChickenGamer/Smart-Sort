...
class FileHandler(FileSystemEventHandler):
    def on_created(self, event):
        ...
        if category == "Documents":
            dest_folder = "/Users/" + username + "/Documents" #"/path/to/Documents"
        elif category == "Media":
            dest_folder = "/Users/"+username+"/Media" #"/path/to/Media"
        elif category == "Images":
            dest_folder = "/Users/"+username+"/Images" #"/path/to/Images"
        else:
            dest_folder = "/Users/"+username+"/Others" #"/path/to/Others"
